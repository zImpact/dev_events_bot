...
from app.config import JIRA_BASE_URL, JIRA_LOGIN_EMAIL, JIRA_API_TOKEN

class JiraRepository:
    def __init__(self):
        self.jira_client = JIRA(
            server=JIRA_BASE_URL,
            basic_auth=(JIRA_LOGIN_EMAIL, JIRA_API_TOKEN)
        )
    ...
    def assign_reviewers(self, key: str, field_id: int, ids: list[int]):
        self.jira_client.issue(key).update(fields={
