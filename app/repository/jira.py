...
class JiraRepository:
    ...
    def get_issue_title(self, key: str) -> str | None:
        try:
    ...
    def get_issue_statuses(self, key: str) -> Any:
    ...
    def move_issue_to_status(self, key: str, status_name: str) -> None:
        ...
        self.jira_client.transition_issue(key, st["id"])  # type: ignore[index]

    def assign_reviewers(
        self, key: str, field_id: int, ids: list[int]
    ) -> None:
